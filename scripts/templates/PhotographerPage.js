        ...
        <div class="photographer_portfolio">
            <div class="photographer_portfolio__sorted_by">
                ...
                <div class="dropdown_menu">
                    <div class="listbox" role="button" tabindex="0" aria-label="liste de tri (trié par popularité)"
                    ...
                    <div class="hidden">
                        <button class="sorting_option" value="popularity" role="listbox" tabindex="0" aria-label="trié par popularité"
                            aria-activedescendant="false" aria-selected="false">Popularité</button>
                    </div>
                    <button class="sorting_option" value="date" role="listbox" tabindex="0" aria-label="trié par date"
                        aria-activedescendant="false" aria-selected="false">Date</button>
                    <button class="sorting_option" value="title" role="listbox" tabindex="0" aria-label="trié par titre"
